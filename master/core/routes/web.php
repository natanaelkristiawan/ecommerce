...
$route->group(['prefix' => env('ADMIN_URL', 'admin')], function ($route) {
    ...
    $route->get('report', 'DashboardResourceController@getReport')->name('admin.report');
    $route->get('report-delete/{id}', 'DashboardResourceController@deleteReport')->name('admin.report.delete');
